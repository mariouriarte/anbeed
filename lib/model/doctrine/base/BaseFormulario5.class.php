 ...
 * @method Formulario5             setEtapa()                        Sets the current record's "Etapa" collection
 * @method Formulario5             setEtapas()                       Sets the current record's "Etapas" collection
 * 
 * @package    anbeed
 * @subpackage model
