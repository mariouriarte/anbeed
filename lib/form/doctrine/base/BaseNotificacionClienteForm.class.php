...
/**
 * NotificacionCliente form base class.
 *
 * @method NotificacionCliente getObject() Returns the current form's model object
 *
 * @package    anbeed
 * @subpackage form
 ...
 */
abstract class BaseNotificacionClienteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('notificacion_cliente[%s]');
