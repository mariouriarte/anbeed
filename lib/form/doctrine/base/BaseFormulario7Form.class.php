...
abstract class BaseFormulario7Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'aval_id'               => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Aval'), 'required' => false)),
      'forma_farmaceutica'    => new sfValidatorString(array('max_length' => 150)),
      ...
      'via_administracion'    => new sfValidatorString(array('max_length' => 150)),
