...
abstract class BaseItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tipo_item'          => new sfWidgetFormChoice(array('choices' => array('UNIMED' => 'UNIMED', 'ANBEED' => 'ANBEED'))),
    ...
    $this->setValidators(array(
      ...
      'producto_unimed_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ProductoUnimed'), 'required' => false)),
      ...
      'tipo_item'          => new sfValidatorChoice(array('choices' => array(0 => 'UNIMED', 1 => 'ANBEED'))),
