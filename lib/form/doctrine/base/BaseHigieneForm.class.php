...
abstract class BaseHigieneForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'phd'           => new sfWidgetFormInputCheckbox(),
      'pahp'          => new sfWidgetFormInputCheckbox(),
      'variedad'      => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'phd'           => new sfValidatorBoolean(array('required' => false)),
      'pahp'          => new sfValidatorBoolean(array('required' => false)),
      'variedad'      => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
