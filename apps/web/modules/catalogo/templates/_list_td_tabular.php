<div class="web_producto">
    <div class="web_foto">
        ...
        echo link_to(image_tag(public_path("images/catalogo/small/".$producto_web->getFoto().""),
                'alt_image='.$producto_web->getNombre().' size=150x150'),"catalogo/edit?id=".$producto_web->getId());
...
//                "catalogo/edit?id=".$producto_web->getId());
    ...
    <div class="web_titulo">
        ...
        <?php  echo link_to($producto_web->getNombre(), "catalogo/edit?id=".$producto_web->getId()) ?>
    </div>
