<div class="wide_content_services">
    ...
    <ul>
        <li>Medicamento Generico esencial importado el pago es de 1300 Bs</li>
        <li>Medicamento Generico no esencial, marca , homeopático, natural  importado 1600 Bs</li>
    </ul>

    <h3>Arancel a INLASA a la cuenta 0689B del Banco Central de Bolivia:</h3>
    <ul>
        <li>Control de calidad del medicamento 1200 Bs</li>
    </ul>
</div>