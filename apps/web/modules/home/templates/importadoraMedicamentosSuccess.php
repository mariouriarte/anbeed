...
<div class="wide_content_services">
    ...
    <div class="sub">
        <div class="imagen-presentacion">
            <img id="servicio" src="/images/web/medicinas.gif"/>
        </div>
    ...
    <div class="sub">
        ...
        <div class="requisitos-dos">
            <div class="lista_requisitos">
                ...
                <ol>
                    <li><p>Pago de 10.000 Bs al Banco Central de Bolivia a la cuenta 3G-300 del Ministerio de Salud y deportes por concepto de apertura de empresa importadora</p></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="wide_content_services">
    ...
    <div class="sub">
        <div class="imagen-presentacion">
            <img id="servicio" src="/images/web/injectable.jpg"/>
        </div>
        <div class="requisitos-dos">
