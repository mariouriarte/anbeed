...
<div class="center_content">
    ...
    <div class="wide_content_services">
        <a name="importadora_medicamentos"></a><h2>Requisitos para Apertura de Empresas Importadoras de Medicamentos S.R.L. ó S.A.</h2>
        <h3>Documentación legal de la empresa:</h3>
         ...
         <h3>Arancel Ministerio de Salud:</h3>
            <ul>
                <li>Pago de 10.000 Bs al Banco Central de Bolivia a la cuenta 3G-300 del Ministerio de Salud y deportes por concepto de apertura de empresa importadora</li>
            </ul>
    </div>
    
    <div class="wide_content_services">
        <a name="importadora_medicamentos"></a><h2>Requisitos para Apertura de Empresas Importadoras de Medicamentos UNIPERSONAL</h2>
        ...
        <h3>Documentacion Regente Farmaceutica:</h3>
            <ul>
                <li> Fotocopia Legalizada <b>Titulo en Provisión Nacional</b> (PERFIL PROFESIONAL FARMACEUTICO)</li>
                <li> Fotocopia <b>Matricula profesional</b></li>
                <li> Fotocopia <b>Carnet de Colegiada</b></li>
