...
<?php include_partial('etapaform516/list_etapas', array('etapas' => $pager->getResults(), 'page' => $pager->getPage())) ?>

<?php if ($pager->haveToPaginate()): ?>
  <div class="pagination">
      
    <a href="<?php echo url_for('etapaform516/new?page=1&idform='.$sf_user->getAttribute('id_form_etapa')) ?>">
    ...
    <a href="<?php echo url_for('etapaform516/new', $etapa) ?>?page=<?php echo $pager->getPreviousPage().'&idform='.$sf_user->getAttribute('id_form_etapa') ?>">
    ...
    <?php foreach ($pager->getLinks() as $page): ?>
      <?php if ($page == $pager->getPage()): ?>
        <?php echo $page ?>
      <?php else: ?>
        <a href="<?php echo url_for('etapaform516/new', $etapa) ?>?page=<?php echo $page.'&idform='.$sf_user->getAttribute('id_form_etapa') ?>"><?php echo $page ?></a>
      <?php endif; ?>
    <?php endforeach; ?>
 <?php echo $sf_user->getAttribute('idform') ?>
    <a href="<?php echo url_for('etapaform516/new', $etapa) ?>?page=<?php echo $pager->getNextPage().'&idform='.$sf_user->getAttribute('id_form_etapa') ?>">
    ...
    <a href="<?php echo url_for('etapaform516/new', $etapa) ?>?page=<?php echo $pager->getLastPage().'&idform='.$sf_user->getAttribute('id_form_etapa') ?>">
