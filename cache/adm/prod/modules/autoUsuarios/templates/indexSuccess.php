...
<div id="sf_admin_container">
  <h1><?php echo __('Listado de Usuarios Registrados', array(), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    <form action="<?php echo url_for('sf_guard_user_usuarios_collection', array('action' => 'batch')) ?>" method="post">
