...
require_once(dirname(__FILE__).'/../lib/BaseUsuariosGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseUsuariosGeneratorHelper.class.php');
 ...
 */
abstract class autoUsuariosActions extends sfActions
{
  ...
  public function executeFilter(sfWebRequest $request)
  {
    ...
    if ($request->hasParameter('_reset'))
    {
      ...
      $this->redirect('@sf_guard_user_usuarios');
    }
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      if ($request->hasParameter('_save_and_add'))
      {
        ...
        $this->redirect('@sf_guard_user_usuarios_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'sf_guard_user_usuarios_edit', 'sf_subject' => $sf_guard_user));
      }
    }
    else
    {
