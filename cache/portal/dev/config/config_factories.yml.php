...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/mario/Development/capsule/anbeed/log/portal_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/mario/Development/capsule/anbeed/cache/portal/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/mario/Development/capsule/anbeed/apps/portal/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/mario/Development/capsule/anbeed/cache/portal/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/mario/Development/capsule/anbeed/apps/portal/template',
)));
